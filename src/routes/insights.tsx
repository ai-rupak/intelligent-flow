  ...
  head: () => ({
    meta: [
      { title: "Insights — CentricaSoft" },
      {
        name: "description",
        content:
          "Field notes from the AI and data engineering frontier — agentic systems, RAG patterns, and lakehouse architectures.",
      },
...
const CATEGORIES = ["All", "Agentic AI", "GenAI", "Data Engineering", "Analytics", "Field Notes"] as const;
...
const POSTS = [
  {
    ...
    excerpt: "A breakdown of the retrieval, ranking, rewriting, and routing layers that separate toy demos from production chatbots.",
    author: "Priya Iyer",
    date: "Apr 8, 2026",
    readTime: "7 min",
  },
  {
    ...
    excerpt: "How we moved a top-5 US bank from on-prem Teradata to Snowflake with zero customer-facing incidents.",
    author: "Marcus Chen",
    date: "Apr 3, 2026",
    readTime: "14 min",
  },
  {
    ...
    excerpt: "Dashboards die. Metrics live. Why metric stores like Cube and dbt Semantic Layer are the new center of gravity.",
    author: "Sasha Rao",
    date: "Mar 28, 2026",
    readTime: "9 min",
  },
  {
    ...
    excerpt: "What we learned building tool registries, permission gating, and rollback flows for production agent fleets.",
    author: "Daniel Park",
    date: "Mar 21, 2026",
    readTime: "12 min",
  },
  {
    ...
    excerpt: "Why we stopped asking LeetCode and started asking candidates to debug a hallucinating agent live.",
    author: "Reena Kapoor",
    date: "Mar 14, 2026",
    readTime: "6 min",
  },
  {
    ...
    excerpt: "Treat prompts like code: branches, tests, rollbacks, eval suites. Anything less is technical debt that compounds weekly.",
    author: "Arjun Mehta",
    date: "Mar 7, 2026",
    readTime: "8 min",
  },
