          ...
          <div className="mt-12 grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-start">
            ...
            >
              <p>
                ...
                kept seeing the same pattern: brilliant prototypes that never made it to
                production, and production systems that buckled the moment they met real-world data.
              </p>
              <p>
