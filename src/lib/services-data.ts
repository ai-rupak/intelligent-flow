...
export const SERVICE_CONTENT: Record<string, ServiceContent> = {
  "agentic-ai": {
    ...
    hld: {
      ...
      nodes: [
        ...
        { id: "orch", label: "Agent Orchestrator", sub: "LangGraph", x: 28, y: 38, w: 170, variant: "primary" },
        ...
        { id: "out", label: "Enterprise Output", sub: "Action · Audit", x: 4, y: 80, w: 170, variant: "primary" },
      ],
      edges: [
        { from: "biz", to: "orch" },
        { from: "orch", to: "router" },
  ...
  "genai-chatbots": {
    ...
    hld: {
      height: 580,
      nodes: [
        { id: "user", label: "User Query", sub: "Web · Slack · API", x: 4, y: 6, w: 180, variant: "muted" },
        { id: "iface", label: "Nubo Interface Layer", x: 4, y: 24, w: 180, variant: "primary" },
        { id: "prompt", label: "Prompt Engineering Engine", sub: "System · Few-shot", x: 4, y: 42, w: 220 },
        ...
        { id: "llm", label: "LLM Router", sub: "GPT-4o · Claude", x: 28, y: 60, w: 200, variant: "primary" },
        { id: "guard", label: "Guardrails + Formatter", x: 28, y: 78, w: 220 },
        { id: "deliver", label: "Enterprise Delivery", sub: "API · Slack · CRM", x: 28, y: 92, w: 220, variant: "primary" },
      ],
      edges: [
        { from: "user", to: "iface" },
  ...
  "data-engineering": {
    ...
    hld: {
      ...
      nodes: [
        ...
        { id: "ingest", label: "Ingestion Layer", sub: "CDC · Streaming", x: 22, y: 28, w: 360, variant: "primary" },
        ...
        { id: "warehouse", label: "Lakehouse Layer", sub: "Snowflake · BigQuery · Redshift", x: 18, y: 72, w: 380, variant: "primary" },
  ...
  "data-analytics": {
    ...
    hld: {
      height: 540,
      nodes: [
        { id: "src", label: "Lakehouse", sub: "Snowflake · BQ", x: 4, y: 14, w: 160, variant: "primary" },
        { id: "dbt", label: "dbt Transformations", x: 32, y: 14, w: 180 },
        { id: "sem", label: "Semantic Layer", sub: "Metrics · Dimensions", x: 60, y: 14, w: 200, variant: "primary" },
